...
public class EdithDialogPreference<T extends DialogInterface> extends DialogPreference {

    private EdithPreferenceDialogFragment mFragment;

    public EdithDialogPreference(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    public EdithDialogPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EdithDialogPreference(Context context) {
        super(context);
    }
    ...
    private void setFragment(EdithPreferenceDialogFragment fragment) {
        mFragment = fragment;
    }
    ...
    public static class EdithPreferenceDialogFragment extends PreferenceDialogFragmentCompat {

        public static EdithPreferenceDialogFragment newInstance(String key) {
            final EdithPreferenceDialogFragment fragment = new EdithPreferenceDialogFragment();
        ...
        private EdithDialogPreference getCustomizablePreference() {
            return (EdithDialogPreference) getPreference();
        }
        ...
        private class OnDismissListener implements View.OnClickListener {
            ...
            public void onClick(View view) {
                EdithPreferenceDialogFragment.this.onClick(mDialog, mWhich);
